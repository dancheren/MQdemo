...
public class MqConfig {
     ...
     */
    public static final String TOPIC = "test_ys";
    public static final String PRODUCER_ID = "PID_ys-0505";
    public static final String CONSUMER_ID = "CID_ys-0505";
    ...
    public static final String ACCESS_KEY = "LTAI1f4eB2T2Kjcu";
    public static final String SECRET_KEY = "ZTYPmKMQNWgLmUsmQCxE9ahHwrnJ5b";
